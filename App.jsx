  ...
  const collections = [
    {
      ...
      products: [
        { name: 'EL YON Monogram Tee', price: '£9.99', image: '/al alyan 1 mockup white.png' },
        { name: 'EL YON Creme Tee', price: '£9.99', image: '/al alyan 2 mockup cream.png' },
    ...
    },
    {
      ...
      products: [
        { name: 'Faith Over Fear Tee', price: '£9.99', image: '/fatih over fear mockup.png' },
        ...
        { name: 'Yahweh Saboath Tee', price: '£9.99', image: '/yahweh sabbath mockup.png.png' }
      ]
    },
    {
      ...
      products: [
        ...
        { name: 'The Living God Tee', price: '£9.99', image: '/the fixing god mockup white.png' },
    ...
    },
    {
      ...
      products: [
        { name: 'Christian Identity Tee', price: '£9.99', image: '/christain identity mockup.png' },
        { name: 'My Identity Tee', price: '£9.99', image: '/my identity mockup.png' },
        { name: 'Time Is Running Out Tee', price: '£9.99', image: '/time is burning Out mockup.png.png' },
        { name: 'Time Is Running Tee', price: '£9.99', image: '/Time is running mockup.png' },
        { name: 'Redeemed Hoodie', price: '£9.99', image: '/redamned hoodie mockup.png' }
      ]
    }
  ];
    ...
    <div style={{ backgroundColor: 'white', minHeight: '100vh', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
        ...
        <div key={idx} style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 20px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '30px', alignItems: 'stretch' }}>
            {collection.products.map((product, i) => (
              <div key={i} style={{ backgroundColor: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 2px 10px rgba(0,0,0,0.05)', border: '1px solid #eee', display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ padding: '20px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 'auto', gap: '10px' }}>
                    ...
                    <button onClick={checkout} style={{ backgroundColor: 'black', color: 'white', padding: '10px 20px', borderRadius: '30px', border: 'none', cursor: 'pointer', fontSize: '14px', fontWeight: '500' }}>Buy Now</button>
                  </div>
                </div>
              </div>
            ))}
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 20px' }}>
        <div style={{ backgroundColor: '#111', color: 'white', padding: '60px 20px', textAlign: 'center', borderRadius: '24px' }}>
          ...
          <button onClick={checkout} style={{ backgroundColor: 'white', color: 'black', padding: '12px 32px', borderRadius: '30px', border: 'none', cursor: 'pointer', fontSize: '16px', fontWeight: '500' }}>Start Custom Design</button>
        </div>
      </div>
