...
function App() {
  ...
  const productOptions = [
    { id: 1, name: 'T-Shirt', price: 11.99, priceDisplay: '£11.99', icon: '👕', description: 'Classic fit • 100% cotton • Premium quality' },
    { id: 2, name: 'Sweatshirt', price: 24.99, priceDisplay: '£24.99', icon: '👚', description: 'Oversized fit • Fleece lined • Comfortable' },
  ...
  const collections = [
    {
      ...
      products: [
        { id: 'identity-1', name: 'Christian Identity Front Sweatshirt', price: 24.99, priceDisplay: '£24.99', image: '/christian identity front black mockup.png' },
        { id: 'identity-2', name: 'Christian Identity Tee', price: 11.99, priceDisplay: '£11.99', image: '/christian identity mockup.png' },
        { id: 'identity-3', name: 'My Identity Sweatshirt', price: 24.99, priceDisplay: '£24.99', image: '/my identity mockup.png' },
        { id: 'identity-4', name: 'Redeemed Front Sweatshirt', price: 24.99, priceDisplay: '£24.99', image: '/redeemed front mockup.png' },
        { id: 'identity-5', name: 'The Almighty White Tee', price: 11.99, priceDisplay: '£11.99', image: '/the almighty white mockup.png' },
        { id: 'identity-6', name: 'Light of The World Tee', price: 11.99, priceDisplay: '£11.99', image: '/Light of the world mockup.png' }
      ]
    },
    {
      ...
      products: [
        { id: 'signature-2', name: 'EL Elyon 2 Tee', price: 11.99, priceDisplay: '£11.99', image: '/el elyon 2 mockup.png' },
        { id: 'signature-3', name: 'EL Elyon White Tee', price: 11.99, priceDisplay: '£11.99', image: '/el elyon white mockup.png' }
      ]
    },
    {
      ...
      products: [
        { id: 'royal-1', name: 'King of Kings Black Tee', price: 11.99, priceDisplay: '£11.99', image: '/King of Kings black mockup.png' },
        { id: 'royal-2', name: 'King of Kings Second Tee', price: 11.99, priceDisplay: '£11.99', image: '/King of Kings second mockup.png' },
        { id: 'royal-3', name: 'The Prince of Peace Tee', price: 11.99, priceDisplay: '£11.99', image: '/the prince of peace mockup.png' },
        { id: 'royal-4', name: 'Prince of Peace Sweatshirt', price: 24.99, priceDisplay: '£24.99', image: '/prince of peace sweat mockup.png' }
      ]
    },
    {
    ...
    },
    {
      ...
      products: [
        { id: 'scripture-1', name: 'The First and The Last Black Tee', price: 11.99, priceDisplay: '£11.99', image: '/the first and the last black mockup.png' },
        { id: 'scripture-2', name: 'The Living God Tee', price: 11.99, priceDisplay: '£11.99', image: '/the living god mockup.png' },
        { id: 'scripture-3', name: 'The Holy One Tee', price: 11.99, priceDisplay: '£11.99', image: '/the holy one mockup.png' },
        { id: 'scripture-4', name: 'The Way Tee', price: 11.99, priceDisplay: '£11.99', image: '/the way mockup.png' },
        { id: 'scripture-5', name: 'The Way The Truth The Life Tee', price: 11.99, priceDisplay: '£11.99', image: '/the way the truth and the life mockup.png' }
      ]
    }
  ];
